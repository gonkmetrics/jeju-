...
public class ReservationController {
	...
	public ResponseEntity<List<Reservation>> list() {
		ResponseEntity<List<Reservation>> entity = null;
		
		try {
			entity = new ResponseEntity<>(service.getAllReservationList(), HttpStatus.OK);
		} catch(Exception e) {
			e.printStackTrace();
	...
	public ResponseEntity<List<Reservation>> list (
			...
			try {
				entity = new ResponseEntity<>(
						service.ReservationList(userId), HttpStatus.OK);			
			} catch(Exception e) {
				e.printStackTrace();
				entity = new ResponseEntity<>(HttpStatus.BAD_REQUEST);
			}
